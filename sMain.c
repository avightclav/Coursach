...
Float myFunctIntegr1(Float x) //������� ��� ���������� ��������� ��� L
{
...
int nofun;
float res = 0;
Float L = Quanc8(myFunctIntegr1, 0, 1, 1.0e-6, res, &errest, &nofun, &flag); //���������� �������� L
...
int main()
{
    Float K = FMin(averageQuadSumm, 36, 46, 0.0001);//��������� �������
    std::cout << K << '\n';
    system("pause");
